...
namespace StudentsManagement.Controllers
{
    ...
    public class SubjectController : ControllerBase
    {
        ...
        [HttpGet("subjects/paginated")]
        public async Task<IActionResult> GetAllPaginated([FromQuery] SubjectQueryDto dto)
        {
            var subjectsPaginated = await this._subjectService.GetAllPaginated(dto);
            return this.OkResponse("Matérias listadas com sucesso.", subjectsPaginated);
        }
