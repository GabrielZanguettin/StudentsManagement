...
namespace StudentsManagement.Controllers
{
    ...
    public class InstitutionController : ControllerBase
    {
        ...
        [HttpGet("institutions/paginated")]
        public async Task<IActionResult> GetAllPaginated([FromQuery] InstitutionQueryDto dto)
        {
            var institutionsPaginated = await this._institutionService.GetAllPaginated(dto);
            return this.OkResponse("Instituições listadas com sucesso.", institutionsPaginated);
        }
