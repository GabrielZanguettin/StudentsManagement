...
namespace StudentsManagement.Controllers
{
    ...
    public class StudentController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetAllPaginated([FromQuery] StudentQueryDto dto)
        {
            var studentsPaginated = await this._studentService.GetAllPaginated(dto);
            return this.OkResponse("Alunos listados com sucesso.", studentsPaginated);
        }
