...
namespace StudentsManagement.Controllers
{
    ...
    public class CourseController : ControllerBase
    {
        ...
        [HttpGet("courses/paginated")]
        public async Task<IActionResult> GetAllPaginated([FromQuery] CourseQueryDto dto)
        {
            var coursesPaginated = await this._courseService.GetAllPaginated(dto);
            return this.OkResponse("Cursos listados com sucesso.", coursesPaginated);
        }
