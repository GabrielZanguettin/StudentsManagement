...
namespace StudentsManagement.Services
{
    public class CourseService : ICourseService
    {
        ...
        public async Task<PaginatedResponse<CourseResponseDto>> GetAllPaginated(CourseQueryDto dto)
        {
            var query = CourseQueryValidator.Normalize(dto);

            var coursesPaginated = await this._courseRepository.GetAllPaginated(query);

            var items = coursesPaginated.Items
                .Select(c => c.ToCourseResponseDto())
                .ToList();
