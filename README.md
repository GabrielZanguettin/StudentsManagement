...
│   │   ├── Courses/
│   │   │   ├── CourseValidator.cs
│   │   │   ├── CourseQueryValidator.cs
│   │   │   └── Models/
│   │   │       └── CourseQuery.cs
│   │   ├── Institutions/
│   │   │   ├── InstitutionValidator.cs
│   │   │   ├── InstitutionQueryValidator.cs
│   │   │   └── Models/
│   │   │       └── InstitutionQuery.cs
│   │   ├── Students/
│   │   │   ├── StudentValidator.cs
│   │   │   ├── StudentQueryValidator.cs
│   │   │   └── Models/
│   │   │       └── StudentQuery.cs
│   │   └── Subjects/
│   │       ├── SubjectValidator.cs
│   │       ├── SubjectQueryValidator.cs
│   │       └── Models/
│   │           └── SubjectQuery.cs
│   ├── Infrastructure/
...
### Helpers
Utilitários e builders para operações comuns, como construção de paginação e formatação de dados.
